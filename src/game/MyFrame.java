...
public class MyFrame extends JFrame implements ActionListener, Runnable {
    ...
    public MyFrame() throws MalformedURLException {
        ...
        setVisible(true);
        File file = new File("C:\\Users\\Admin\\OneDrive\\Documents\\NetBeansProjects\\Group1");
        URL url = null;
	...
	// tao panel chua diem va thoi gian
	...
	// tao panel chua panelScoreAndTime va nut new game
	...
	// dung panel bo tri Layout BorderLayout cho panel dieu khien ben tren
	JPanel panel = new JPanel(new BorderLayout());
